...
KNOWN_BAD_BOTS = [
    ...
    {"id": "bytedance",     "label": "ByteDance",          "pattern": "Bytedance",      "description": "Rastreadores de ByteDance/TikTok (varios UA)"},
    {"id": "amazonbot",     "label": "AmazonBot",          "pattern": "Amazonbot",      "description": "Bot de scraping de Amazon"},
    {"id": "meta_ai",       "label": "Meta AI (externalagent)","pattern": "meta-externalagent","description": "Scraper de IA de Meta (entrena modelos). NO es el de previews de FB/WhatsApp"},
    {"id": "perplexitybot", "label": "PerplexityBot",      "pattern": "PerplexityBot",  "description": "Bot de scraping de la IA Perplexity"},
    {"id": "dataforseo",    "label": "DataForSeoBot",      "pattern": "DataForSeoBot",  "description": "Revende datos SEO scrapeados; muy agresivo"},
    {"id": "scrapy",        "label": "Scrapy",             "pattern": "Scrapy",         "description": "Framework de scraping en Python"},
    {"id": "timpibot",      "label": "Timpibot",           "pattern": "Timpibot",       "description": "Bot de scraping para datasets de IA"},
